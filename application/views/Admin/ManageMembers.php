                      ...
                      <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo base_url(); ?>index.php/Admin/ViewUser/<?php echo $User['ID']; ?>">View Profile</a></li>
                                    <li><a href="<?php echo base_url(); ?>index.php/Admin/Remove/<?php echo $User['ID']; ?>">Remove</a></li>
